...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('assets/css/styleh.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/plugins/sweetalert2/sweetalert2.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('assets/plugins/bootstrap-select/css/bootstrap-select.min.css')); ?>" rel="stylesheet" type="text/css">
    <!-- jQuery  -->
  ...
  <body>
        ...
        <div class="topbar-main">
          <div class="container-fluid">
            ...
            <div class="float-right">
              <img src="<?php echo e(asset('assets/images/pertamina-logo.png')); ?>" class="logo-lg" alt="" height="52">
              <img src="<?php echo e(asset('assets/images/pertamina-logo.png')); ?>" class="logo-sm" alt="" height="56">
            </div>
          </div>
          <!-- end container -->
        </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-10">
                      <select name="lokasi_kerja" id="lokasi_kerja" class="form-control selectpicker" data-live-search="true">
                        ...
                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->lokasi_kerja); ?></option>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <video class="w-100" id="training-video" controls>
                  <source src="<?php echo e(asset('videos/video_training.mp4')); ?>" type="video/mp4" autoplay>
              ...
              <div class="card-body">
                ...
                <form id="f-posttest" class="mt-4">
                  ...
                  <div class="form-group">
                    <input type="hidden" name="id_soal[]" value="<?php echo e($s['id']); ?>">
                    <h5>Soal <?php echo e($i + 1); ?></h5>
                    <label class="form-label"><?php echo e($s['soal']); ?></label>
                    <div>
                    <?php $__currentLoopData = $s['pilihan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check">
                      <input type="radio" name="pilihan_<?php echo e($s['id']); ?>" class="form-check-input" value="<?php echo e($pil['id']); ?>">
                      <label for="pilihan_<?php echo e($s['id']); ?>" class="form-check-label"><?php echo e($pil['pilihan']); ?></label>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                  </div>
    ...
    <script>
      ...
      $('#btn-daftar').click(function() {
        $.post("<?php echo e(url('daftar')); ?>", $('#f-daftar').serialize()).done(res => {
          if (res.success) {
            ...
            video.addEventListener('ended', function () {
              $.put(`<?php echo e(url('start_test')); ?>/${$('#id_pengunjung').val()}`, {
      ...
      $('#btn-submit').click(function() {
        Swal.fire({
          ...
          if (res.value) {
            $.put(`<?php echo e(url('submit_test')); ?>/${$('#id_pengunjung').val()}`, $('#f-posttest').serialize()).done(res => {
              let totalSkor = 0;
              let htmlRekapSoal = '';
...
<?php /**PATH /home/u543412378/domains/secptmho.online/public_html/resources/views/home.blade.php ENDPATH**/ ?>